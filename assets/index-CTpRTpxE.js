...
`;function Zo(){const r=Wa();return o.jsxs(o.Fragment,{children:[o.jsx("style",{children:Gv}),o.jsxs("div",{className:"brand-logo",onClick:()=>r("/"),children:[o.jsx("img",{src:qv,alt:"NowFix",className:"brand-logo-img"}),o.jsxs("span",{className:"brand-logo-text",children:[o.jsx("span",{className:"brand-logo-now",children:"NOW"}),o.jsx("span",{className:"brand-logo-fix",children:"FIX"})]})]})]})}const Xv=`
...
`;function ig(){const r=Wa(),[f,d]=C.useState(1),[c,h]=C.useState(""),[p,b]=C.useState(["","","",""]);function A(){c.length===10&&(console.log("Sending OTP to:",c),d(2))}function S(B,U){if(!/^\d*$/.test(B))return;const X=[...p];X[U]=B,b(X),B&&U<3&&document.getElementById(`otp-${U+1}`).focus()}function v(B,U){B.key==="Backspace"&&!p[U]&&U>0&&document.getElementById(`otp-${U-1}`).focus()}function M(){const B=p.join("");console.log("Verifying OTP:",B,"for phone:",c),r("/")}const E=({width:B=24,height:U=16})=>o.jsxs("svg",{width:B,height:U,viewBox:"0 0 36 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",style:{borderRadius:"2px",display:"block",flexShrink:0},children:[o.jsx("rect",{width:"36",height:"8",fill:"#FF9933"}),o.jsx("rect",{y:"8",width:"36",height:"8",fill:"#FFFFFF"}),o.jsx("rect",{y:"16",width:"36",height:"8",fill:"#138808"}),o.jsx("circle",{cx:"18",cy:"12",r:"3.5",stroke:"#000080",strokeWidth:"0.8"}),o.jsx("circle",{cx:"18",cy:"12",r:"1",fill:"#000080"})]});return o.jsxs(o.Fragment,{children:[o.jsx("style",{children:ng}),o.jsx("div",{className:"login-page",children:o.jsxs("div",{className:"login-card",children:[o.jsx("div",{className:"login-header",children:o.jsx(Zo,{})}),f===1&&o.jsxs(o.Fragment,{children:[o.jsx("h1",{className:"login-title",children:"Welcome Back"}),o.jsx("p",{className:"login-sub",children:"Enter your mobile number to log in or sign up."}),o.jsx("label",{className:"login-label",children:"Mobile Number"}),o.jsxs("div",{className:"login-phone-wrap",children:[o.jsx("div",{className:"login-phone-prefix",children:o.jsx(E,{width:24,height:16})}),o.jsx("input",{className:"login-phone-input",type:"tel",maxLength:10,placeholder:"98765 43210",value:c,onChange:B=>h(B.target.value.replace(/\D/g,"")),onKeyDown:B=>B.key==="Enter"&&A(),autoFocus:!0})]}),o.jsx("button",{className:"login-btn",onClick:A,disabled:c.length!==10,children:"Send OTP →"}),o.jsxs("p",{className:"login-terms",children:["By continuing, you agree to our"," ",o.jsx("span",{children:"Terms of Service"})," and"," ",o.jsx("span",{children:"Privacy Policy"})]})]}),f===2&&o.jsxs(o.Fragment,{children:[o.jsx("button",{className:"login-back",onClick:()=>d(1),children:"← Change Number"}),o.jsx("h1",{className:"login-title",children:"Enter OTP"}),o.jsx("p",{className:"login-sub",children:"We sent a 4-digit code to"}),o.jsxs("div",{className:"otp-phone-display",children:[o.jsx(E,{width:20,height:14}),o.jsx("span",{children:c})]}),o.jsx("div",{className:"otp-wrap",children:p.map((B,U)=>o.jsx("input",{id:`otp-${U}`,className:`otp-input${B?" filled":""}`,type:"tel",maxLength:1,value:B,onChange:X=>S(X.target.value,U),onKeyDown:X=>v(X,U),autoFocus:U===0},U))}),o.jsxs("p",{className:"otp-resend",children:["Didn't receive the code?"," ",o.jsx("span",{onClick:()=>{b(["","","",""]),console.log("Resending OTP...")},children:"Resend OTP"})]}),o.jsx("button",{className:"login-btn",onClick:M,disabled:p.some(B=>B===""),children:"Verify & Continue →"})]})]})})]})}const ug=`
  .join-page {
    min-height: 100vh;
    background: var(--bg-2, #F9FAFB);
    display: flex;
...
`,rg=["Plumbing","Electrician","AC Repair","Home Cleaning","Carpentry","Appliance Repair","Painting","Pest Control"];function og(){const r=Wa(),[f,d]=C.useState(null),[c,h]=C.useState(!1),[p,b]=C.useState({name:"",phone:"",category:"",experience:"",city:"Bikaner",aadhar:""});function A(E){const B=E.target.files[0];B&&(d(URL.createObjectURL(B)),console.log("Photo selected for upload:",B.name))}function S(E){const B=E.target.files[0];B&&(h(!0),console.log("Aadhar selected for upload:",B.name))}function v(E,B){b(U=>({...U,[E]:B}))}function M(){console.log("Submitting worker application data:",p),alert("Application submitted successfully! We will contact you soon."),r("/")}return o.jsxs(o.Fragment,{children:[o.jsx("style",{children:ug}),o.jsx("div",{className:"join-page",children:o.jsxs("div",{className:"join-card",children:[o.jsx("div",{className:"join-header",children:o.jsx(Zo,{})}),o.jsx("h1",{className:"join-title",children:"Join as a Worker"}),o.jsx("p",{className:"join-sub",children:"Fill in your details to start receiving jobs in Bikaner"}),o.jsxs("div",{className:"join-photo-wrap",children:[o.jsx("div",{className:"join-photo-circle",onClick:()=>document.getElementById("photo-input").click(),children:f?o.jsx("img",{src:f,alt:"Profile"}):o.jsxs(o.Fragment,{children:[o.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[o.jsx("path",{d:"M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"}),o.jsx("circle",{cx:"12",cy:"7",r:"4"})]}),o.jsx("span",{children:"Add Photo"})]})}),o.jsx("span",{className:"join-photo-label",onClick:()=>document.getElementById("photo-input").click(),children:f?"Change Photo":"Upload Profile Photo"}),o.jsx("input",{id:"photo-input",type:"file",accept:"image/*",style:{display:"none"},onChange:A})]}),o.jsx("p",{className:"join-section-label",children:"Personal Information"}),o.jsxs("div",{className:"join-row",children:[o.jsxs("div",{className:"join-field no-margin",children:[o.jsx("label",{children:"Full Name"}),o.jsx("input",{className:"join-input",type:"text",placeholder:"Ramesh Kumar",value:p.name,onChange:E=>v("name",E.target.value)})]}),o.jsxs("div",{className:"join-field no-margin",children:[o.jsx("label",{children:"Phone Number"}),o.jsxs("div",{className:"join-phone-wrap",children:[o.jsx("div",{className:"join-phone-prefix",children:"🇮🇳 +91"}),o.jsx("input",{className:"join-phone-input",type:"tel",placeholder:"98765 43210",maxLength:10,value:p.phone,onChange:E=>v("phone",E.target.value.replace(/\D/g,""))})]})]})]}),o.jsx("div",{className:"join-divider"}),o.jsx("p",{className:"join-section-label",children:"Work Information"}),o.jsxs("div",{className:"join-row",children:[o.jsxs("div",{className:"join-field no-margin",children:[o.jsx("label",{children:"Service Category"}),o.jsxs("select",{className:"join-select",value:p.category,onChange:E=>v("category",E.target.value),children:[o.jsx("option",{value:"",children:"Select category"}),rg.map(E=>o.jsx("option",{value:E,children:E},E))]})]}),o.jsxs("div",{className:"join-field no-margin",children:[o.jsx("label",{children:"Experience"}),o.jsxs("select",{className:"join-select",value:p.experience,onChange:E=>v("experience",E.target.value),children:[o.jsx("option",{value:"",children:"Select years"}),o.jsx("option",{value:"0-1",children:"Less than 1 year"}),o.jsx("option",{value:"1-3",children:"1 - 3 years"}),o.jsx("option",{value:"3-5",children:"3 - 5 years"}),o.jsx("option",{value:"5+",children:"5+ years"})]})]})]}),o.jsx("div",{className:"join-divider"}),o.jsx("p",{className:"join-section-label",children:"Identity Verification"}),o.jsxs("div",{className:"join-field",children:[o.jsx("label",{children:"Aadhar Card Number"}),o.jsx("input",{className:"join-input",type:"tel",placeholder:"1234 5678 9012",maxLength:14,value:p.aadhar,onChange:E=>v("aadhar",E.target.value)})]}),o.jsxs("div",{className:`join-upload-box${c?" uploaded":""}`,onClick:()=>document.getElementById("aadhar-input").click(),children:[c?o.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[o.jsx("path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14"}),o.jsx("polyline",{points:"22 4 12 14.01 9 11.01"})]}):o.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[o.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),o.jsx("polyline",{points:"17 8 12 3 7 8"}),o.jsx("line",{x1:"12",y1:"3",x2:"12",y2:"15"})]}),o.jsx("span",{className:"join-upload-title",children:c?"Aadhar Card Uploaded ✓":"Upload Aadhar Card"}),o.jsx("span",{className:"join-upload-sub",children:c?"Tap to change file":"JPG, PNG or PDF — max 5MB"}),o.jsx("input",{id:"aadhar-input",type:"file",accept:"image/*,.pdf",style:{display:"none"},onChange:S})]}),o.jsx("button",{className:"join-submit",onClick:M,children:"Submit Application →"})]})})]})}const cg=`
  .sd-page {
    min-height: 100vh;
    background: var(--bg-2);
    font-family: var(--font-body);
