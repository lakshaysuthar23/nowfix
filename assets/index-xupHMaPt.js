...
`;function ig(){const r=Wa(),[f,d]=C.useState(1),[c,h]=C.useState(""),[p,S]=C.useState(["","","",""]);function A(){c.length===10&&(console.log("Sending OTP to:",c),d(2))}function E(x,_){if(!/^\d*$/.test(x))return;const U=[...p];U[_]=x,S(U),x&&_<3&&document.getElementById(`otp-${_+1}`).focus()}function v(x,_){x.key==="Backspace"&&!p[_]&&_>0&&document.getElementById(`otp-${_-1}`).focus()}function M(){const x=p.join("");console.log("Verifying OTP:",x,"for phone:",c),r("/")}return o.jsxs(o.Fragment,{children:[o.jsx("style",{children:ng}),o.jsx("div",{className:"login-page",children:o.jsxs("div",{className:"login-card",children:[o.jsx("div",{className:"login-header",children:o.jsx(Zo,{})}),f===1&&o.jsxs(o.Fragment,{children:[o.jsx("h1",{className:"login-title",children:"Welcome Back"}),o.jsx("p",{className:"login-sub",children:"Enter your mobile number to log in or sign up."}),o.jsx("label",{className:"login-label",children:"Mobile Number"}),o.jsxs("div",{className:"login-phone-wrap",children:[o.jsx("div",{className:"login-phone-prefix",children:o.jsxs("svg",{width:"24",height:"auto",viewBox:"0 0 36 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",style:{borderRadius:"2px",display:"block"},children:[o.jsx("rect",{width:"36",height:"8",fill:"#FF9933"}),o.jsx("rect",{y:"8",width:"36",height:"8",fill:"#FFFFFF"}),o.jsx("rect",{y:"16",width:"36",height:"8",fill:"#138808"}),o.jsx("circle",{cx:"18",cy:"12",r:"3.5",stroke:"#000080",strokeWidth:"0.8"}),o.jsx("circle",{cx:"18",cy:"12",r:"1",fill:"#000080"})]})}),o.jsx("input",{className:"login-phone-input",type:"tel",maxLength:10,placeholder:"98765 43210",value:c,onChange:x=>h(x.target.value.replace(/\D/g,"")),onKeyDown:x=>x.key==="Enter"&&A(),autoFocus:!0})]}),o.jsx("button",{className:"login-btn",onClick:A,disabled:c.length!==10,children:"Send OTP →"}),o.jsxs("p",{className:"login-terms",children:["By continuing, you agree to our"," ",o.jsx("span",{children:"Terms of Service"})," and"," ",o.jsx("span",{children:"Privacy Policy"})]})]}),f===2&&o.jsxs(o.Fragment,{children:[o.jsx("button",{className:"login-back",onClick:()=>d(1),children:"← Change Number"}),o.jsx("h1",{className:"login-title",children:"Enter OTP"}),o.jsx("p",{className:"login-sub",children:"We sent a 4-digit code to"}),o.jsxs("div",{className:"otp-phone-display",children:[o.jsxs("svg",{width:"20",height:"14",viewBox:"0 0 36 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",style:{borderRadius:"2px",display:"block"},children:[o.jsx("rect",{width:"36",height:"8",fill:"#FF9933"}),o.jsx("rect",{y:"8",width:"36",height:"8",fill:"#FFFFFF"}),o.jsx("rect",{y:"16",width:"36",height:"8",fill:"#138808"}),o.jsx("circle",{cx:"18",cy:"12",r:"3.5",stroke:"#000080",strokeWidth:"0.8"}),o.jsx("circle",{cx:"18",cy:"12",r:"1",fill:"#000080"})]}),o.jsx("span",{children:c})]}),o.jsx("div",{className:"otp-wrap",children:p.map((x,_)=>o.jsx("input",{id:`otp-${_}`,className:`otp-input${x?" filled":""}`,type:"tel",maxLength:1,value:x,onChange:U=>E(U.target.value,_),onKeyDown:U=>v(U,_),autoFocus:_===0},_))}),o.jsxs("p",{className:"otp-resend",children:["Didn't receive the code?"," ",o.jsx("span",{onClick:()=>{S(["","","",""]),console.log("Resending OTP...")},children:"Resend OTP"})]}),o.jsx("button",{className:"login-btn",onClick:M,disabled:p.some(x=>x===""),children:"Verify & Continue →"})]})]})})]})}const ug=`
  .join-page {
    min-height: 100vh;
    background: var(--bg-2, #F9FAFB);
    display: flex;
